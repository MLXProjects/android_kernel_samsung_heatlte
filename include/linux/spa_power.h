...
#endif
	SPA_STATUS_USB_UNCONFIG,
	SPA_STATUS_USB_CONFIG,
...
struct spa_power_data
{
	...
	unsigned int lpm_compensation_eoc_current;
...
extern int init_spa_power(void);
#endif
