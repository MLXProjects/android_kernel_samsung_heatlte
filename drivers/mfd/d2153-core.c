...
static void d2153_usb_event_init(struct d2153 *d2153)
{
	...
	if (ret)
		printk(KERN_ERR "D2153 i2c write failed on VBUS work");
...
#ifdef D2153_SUPPORT_I2C_USE_PAGE_WRITE_MODE
	d2153_set_bits(d2153, D2153_CONTROL_B_REG, D2153_WRITE_MODE_MASK);//always repeat mode during power off
#endif	// D2153_SUPPORT_I2C_USE_PAGE_WRITE_MODE
