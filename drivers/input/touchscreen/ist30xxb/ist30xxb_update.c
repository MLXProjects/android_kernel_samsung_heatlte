...
#include "./firmware/IST30xxB_FW_VIVALTOLTE_0X0015.h"
...
int ist30xx_check_auto_update(struct ist30xx_data *data)
{
	...
	if ((fw->param_ver > 0) && (fw->param_ver < 0xFFFFFFFF)) {
		if (((fw->core_ver & MASK_FW_VER) != IST30XX_FW_VER3) &&	
