...
#define CMSTR15_PHYS	0xe6130500
#define CMSTR15		IO_ADDRESS(CMSTR15_PHYS)
...
extern void r8a7373_clk_print_active_clks(void);
...
extern void r8a7373_set_panel_func(struct fb_panel_func (*fn)(int));
#endif
